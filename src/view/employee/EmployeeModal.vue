    ...
    <div id="modal-info" class="modal" v-bind:class="{ show: isShow }">
      <div class="modal-content">
          ...
          <div class="avatar-and-form">
            ...
            <div id="form-info-modal" class="form-info">
              <div class="infor-employee">
                ...
                <div
                  style="background-color: green; width: 65px; height: 5px"
                ></div>
                <div class="info-input" style="display: block">
                  <div style="display: flex">
                    <div class="input-left">
                      <span
                        >Mã nhân viên <span style="color: red">(*)</span></span
                      >
                      <div class="">
                        <input
                          required
                  ...
                  <div style="display: flex">
                    <div class="input-left">
                      ...
                      <input
                        ...
                        @keyup="fomatDateOfBirth"
                      />
                    </div>
                    <div class="input-right">
                      <div style="margin-top: 16px">Giới tính</div>
                      <ComboboxGender
                        @cbbDataOnClick="onCbbClick"
                        v-bind:isShow="isShowComBoboxData"
                      />
                    </div>
                  </div>
                  <div style="display: flex">
                  ...
                  <div style="display: flex">
                    <div class="input-left">
                      ...
                      >
                        ...
                        <div id="combobox-position" class="combobox-data"></div>
                      </div>
                    </div>
                    <div class="input-right">
                      <div>Phòng ban</div>
        ...
        <div class="btn-save-cancel">
          <button
            id="btn-cancel"
            class="btn-cancel btn second-button"
            @click="closeModal"
          >
            Hủy
          </button>
          <button
            id="btn-save"
            class="btn-save button-have-icon"
...
export default {
  ...
  watch: {
    ...
    'employee.DateOfBirth': function(val){
        this.employee.DateOfBirth = Format.dobFormatToForm(val);
    },

    'employee.JoinDate': function(val) {
        this.employee.JoinDate = Format.dobFormatToForm(val);
    },

    'employee.IdentityDate': function(val) {
        this.employee.IdentityDate = Format.dobFormatToForm(val);
    },

    'employee.Salary': function(val) {
        let salaryformat = String(val).replaceAll('.','');
        this.employee.Salary = Format.salaryFormat(salaryformat);
    }
  },

  methods: {
    /**
     * custom event đóng modal để gửi lên component cha
    ...
    btnSaveOnClick() {
      var self = this;
      var submitsalary = String(self.employee.Salary).replaceAll('.','')
      self.employee.Salary = submitsalary;
      if (self.formMode == 0) {
        axios
